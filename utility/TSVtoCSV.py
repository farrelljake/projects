...
def main():
    ...
    parser.add_argument('-d', dest='direction', metavar='Direction of file conversion', help='Specifies the direction of the conversion', choices=["tocsv", "totsv"], default="tocsv")
    parser.add_argument('--excel', dest='excel', metavar='Handle excel tabs', choices=["True"], default=False)
    parser.add_argument('--escape', dest='escape', metavar='Escaping choice', choices=["quotes", "slash", "newline"], default="quotes")
